...
void testCreeaza() {
	std::cout << "Test Creaza Inceput" << std::endl;
	MDO d = MDO(cresc);
	assert(d.dim() == 0);
	assert(d.vid());
	...
	std::cout << "Test Creaza Final" << std::endl;
}

void testCauta(Relatie r) {
	std::cout << "Test Cauta Inceput" << std::endl;
	MDO d = MDO(r);
	int cMin = 0;
	int cMax = 10;
	...
	std::cout << "Test Cauta Final" << std::endl;
}
...
void testStergeCauta(Relatie r) {
	std::cout << "Test Sterge Inceput" << std::endl;
	MDO d = MDO(r);
	int min = 10;
	int max = 20;
	...
	//MDO devine vid
	assert(d.dim() == 0);
	std::cout << "Test Sterge Final" << std::endl;
}
...
void testIterator(Relatie r) {
	std::cout << "Test Iterator Inceput" << std::endl;
	MDO d = MDO(r);
	IteratorMDO it = d.iterator();
	assert(!it.valid());
	it.prim();
	...
	std::cout << "Test Iterator Final" << std::endl;
}
